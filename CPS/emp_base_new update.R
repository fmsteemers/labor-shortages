...
### Read DDI file
ddi_vector <- c("cps_00115.xml","cps_00116.xml","cps_00117.xml","cps_00121.xml")
...
# Reference labels
reference_labels <- ddi_list$cps_00121.xml$var_info$val_labels
names(reference_labels) <- ddi_list$cps_00121.xml$var_info$var_name
